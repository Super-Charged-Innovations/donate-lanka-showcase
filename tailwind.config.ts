	...
	theme: {
		...
		extend: {
			...
			backgroundImage: {
				...
				'gradient-hero': 'linear-gradient(135deg, hsl(var(--background)) 0%, hsl(var(--primary-100)) 25%, hsl(var(--secondary-100)) 75%, hsl(var(--background)) 100%)',
				'gradient-text': 'linear-gradient(135deg, hsl(var(--secondary-700)) 0%, hsl(var(--warning)) 100%)',
			...
			boxShadow: {
				...
				'secondary': '0 4px 14px 0 hsl(var(--secondary) / 0.3)',
			},
			borderRadius: {
				lg: 'var(--radius)',
			...
			animation: {
				...
				'infinite-scroll': 'infinite-scroll 360s linear infinite',
				'infinite-scroll-hover': 'infinite-scroll 360s linear infinite paused',
