    ...
    <div className="relative w-full overflow-hidden py-8">
      ...
      <div className="flex animate-scroll space-x-16">
        ...
        {companyLogos.map((company, index) => (
          <div
            key={`set1-${index}`}
            className="flex-shrink-0 flex items-center justify-center w-28 h-28 rounded-full bg-gradient-to-br from-primary/10 to-secondary/10 border border-border/50"
          >
