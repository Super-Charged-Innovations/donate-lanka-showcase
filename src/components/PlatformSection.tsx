        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          <ScrollReveal animation="fade-left" delay={200}>
            <Card className="group hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border-2 hover:border-primary/50 bg-gradient-hero/5">
              ...
              <div className="text-center mb-8">
                <div className="w-24 h-24 bg-gradient-to-br from-primary/20 to-secondary/20 rounded-3xl flex items-center justify-center mx-auto mb-4">
          ...
          <ScrollReveal animation="fade-right" delay={400}>
            <Card className="group hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border-2 hover:border-secondary/50 bg-gradient-hero/5">
              ...
              {/* Icon and Title */}
              <div className="text-center mb-8">
                <div className="w-48 h-32 bg-gradient-to-br from-secondary/20 to-primary/20 rounded-3xl flex items-center justify-center mx-auto mb-4 p-4">
                  <img src="/donatelanka-logo.png" alt="DonateLanka" className="w-full h-full object-contain" />
                </div>
